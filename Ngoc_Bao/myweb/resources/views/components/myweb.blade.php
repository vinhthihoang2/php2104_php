                ...
                <div class="col-lg-12 d-block">
                    <div class="row d-flex">
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <span class="text">+(84) 967700215</span>
                        </div>
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            <div class="icon mr-2 d-flex justify-content-center align-items-center">
                                <span class="icon-paper-plane"></span>
                            </div>
                            <span class="text">ngocbao0891@gmail.com</span>
                        </div>
                    ...
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                            <li class="ftco-animate">
                                <a href="https://www.facebook.com/baobao080901/">
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4 ml-md-5">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="shop-ms" class="py-2 d-block">Shop</a>
                            </li>
                            <li>
                                <a href="about-ms" class="py-2 d-block">About</a>
                            </li>
                            <li>
                                <a href="#" class="py-2 d-block">Journal</a>
                            </li>
                            <li>
                                <a href="contact-ms" class="py-2 d-block">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li>
                                    ...
                                    <span class="text">Kim Van - Kim Lu - Q.Hoang Mai - TP.Ha Noi</span>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="icon icon-phone"></span>
                                        <span class="text">+(84) 7060515</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>
                        ...
                        </script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://www.facebook.com/baobao080901/" target="_blank">Ngoc Bao</a>
