              ...
              <div class="col-12 col-sm-6">
                ...
                <div class="mt-4">
                  <span class="text-left mr-4">
                    <a href="#" class="mr-2">{{ $products->rate }}</a> 
                    @for ($i=0; $i<$products->rate; $i++) 
                    <span class="far fa-star"></span> 
                    @endfor 
                  </span>
                  <span class="text-left mr-4">
                    <a href="#" class="mr-2" style="color: #000;">{{ $products->sold }}&ensp; <span style="color: #bbb;">Sold</span>
                    </a>
                  </span>
                  <span class="text-left mr-4">
                    <a href="#" class="mr-2" style="color: #000;">{{ $products->sale_off }}%&ensp; <span style="color: #bbb;">Sale Off</span>
                    </a>
                  </span>
                </div>
                <div class=" mt-4">
                  <span style="color: #bbb;">Price</span>
                  <h2 class="mb-0"> ${{ $products->price }}
                  </h2>
                </div>
                <div class=" mt-4">
