                ...
                <div class="col-lg-12 d-block">
                    <div class="row d-flex">
                        ...
                        <div class="col-md pr-4 d-flex topper align-items-center">
                            ...
                            <span class="text">Phuongnyo98@gmail.com</span>
                        </div>
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                            ...
                            <li class="ftco-animate">
                                <a href="https://www.facebook.com/nguyenthuphuon9/">
                                    <span class="icon-facebook"></span>
                                </a>
                            </li>
                            <li class="ftco-animate">
                                <a href="https://www.instagram.com/ng.tphuon/">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li>
                                    ...
                                    <span class="text">7B/79A Luong Khanh Thien - P.Tuong Mai - Q.Hoang Mai - TP.Ha Noi</span>
                                </li>
                                <li>
                                    <a href="#">
